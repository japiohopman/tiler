...
This section is the **Jules execution queue**. Jules dispatches only the first unchecked task under `### Ready`. Tasks stay in place; completion is recorded by changing the task checkbox from `[ ]` to `[x]` after verification.
...
- [ ] 4.1 — Information Architecture
  ...
  - **Dependency:** Phase 3.7 final verification and immediate stabilization gates must be complete.
