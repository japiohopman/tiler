...
import { useImageEditor, EditorTab, ComparisonMode } from '../../hooks/useImageEditor';
...
export const ImageEditor: React.FC<ImageEditorProps> = ({
  ...
  const {
    ...
    handleApply,
    handleCancel,
  } = useImageEditor({ asset, onApplyEdits, onCancel });
  ...
  return (
    <div className={`bg-slate-900/90 border border-slate-800 rounded-2xl p-5 shadow-2xl flex flex-col gap-5 ${className}`}>
      ...
      {/* Editor Action Footer Bar (Reset All, Cancel, Apply) */}
