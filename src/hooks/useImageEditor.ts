...
export type ComparisonMode = 'edit' | 'raw' | 'split';
...
export function useImageEditor({ asset, onApplyEdits, onCancel }: UseImageEditorOptions) {
  ...
  // Reset all adjustments to asset default
